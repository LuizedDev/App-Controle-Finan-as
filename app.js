...
class Bd {
	...
	recuperarTodosRegistros() {
		...
		for(let i = 1; i <= id; i++) {
			...
			//nestes casos nós vamos pular esse indices
...
function cadastrarDespesa () {
	...
	if(despesa.validarDados()) {
		...
		bd.gravar(despesa) //coracao do ato de gravar os dados

		document.getElementById('modal_titulo').innerHTML = 'Registro inserido com sucesso!'
		document.getElementById('modal_titulo_div').className = 'modal-header text-success'
		document.getElementById('texto_modal').innerHTML = 'Dispesa foi cadastro com sucesso!'
		...
		document.getElementById('texto_modal').innerHTML = 'Erro na gravação, verifique se todos os campos foram preenchidos corretamente.'
